...
[![Repos: 128](https://img.shields.io/badge/repositories-128-c9a227?style=flat-square)](#)
...
A master index of every public ROOT0 / TriPod repository (128) — governance, physics, security, lineage, memory, tools, and writing — catalogued, categorized, searchable, and linked. Each card links to the source on GitHub; HTML repos with Pages also carry a live demo link.
...
| Physics · Energy · Hardware | 12 | Particle sims, holograms, reactors, Dyson/black-hole energy, lab references, `elementals`, `photonic` (a 128-bit photonic processor concept) |
