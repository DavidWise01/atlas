...
[![Repos: 120](https://img.shields.io/badge/repositories-120-c9a227?style=flat-square)](#)
...
A master index of every public ROOT0 / TriPod repository (120) — governance, physics, security, lineage, memory, tools, and writing — catalogued, categorized, searchable, and linked. Each card links to the source on GitHub; HTML repos with Pages also carry a live demo link.
...
| Codices · Rosters | 5 | Muster rolls of avatar agents — `bridge-burners`, `black-company`, `wheel-of-time`, `gap-cycle`, `white-gold-wielder` |
