...
[![Repos: 138](https://img.shields.io/badge/repositories-138-c9a227?style=flat-square)](#)
...
A master index of every public ROOT0 / TriPod repository (138) — governance, physics, security, lineage, memory, tools, and writing — catalogued, categorized, searchable, and linked. Each card links to the source on GitHub; HTML repos with Pages also carry a live demo link.
...
| Physics · Energy · Hardware | 18 | Particle sims, holograms, reactors, Dyson/black-hole energy, `elementals`, `quantum-box`, and the processor concepts `photonic` · `boronic` · `liquid` |
