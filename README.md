...
[![Repos: 134](https://img.shields.io/badge/repositories-134-c9a227?style=flat-square)](#)
...
A master index of every public ROOT0 / TriPod repository (134) — governance, physics, security, lineage, memory, tools, and writing — catalogued, categorized, searchable, and linked. Each card links to the source on GitHub; HTML repos with Pages also carry a live demo link.
